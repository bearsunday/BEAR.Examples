...
| File | Read when |
|------|-----------|
| [handoff.md](handoff.md) | First. Especially as a new session opening this repo |
...
`review-skill.md` and `skill-proposals.md` are not BEAR.Cms-specific
content; they originated here but belong eventually in
`bearsunday/BEAR.Skills` as proper skills.
